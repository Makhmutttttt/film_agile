            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-10 col-sm-12">
                        <div class="about-info">
                            <h3>Возможности</h3>
                            <h1>На данном веб-сайте вы имеете возможность обсуждать ваши любимые фильмы на различные темы и объединяться в сообщества посвященные отдельным сериалам, аналогично фан-клубам. В качестве фанатов, вы можете формулировать свои предположения, оставлять комментарии и создавать личные страницы в роли эксперта по своим любимым фильмам и сериалам. Все эти данные сохраняются на вашем аккаунте, и другие пользователи могут просматривать ваши личные догадки и теории, а также выражать свое мнение об этом.</h1>
                        </div>
                </div>
